...
1. [x] **No scalable SVG app icon** — ~~Flathub requires `hicolor/scalable/apps/com.petrariu.NorthMail.svg`. Only PNGs exist.~~ Done: SVG icon added.
...
17. [ ] **About dialog uses `"email"` icon** instead of `"com.petrariu.NorthMail"`.
